	...
	const getSummarySegmentRight = () => {
		...
		if ( ! props.wphbData.isMultisite ) {
			if ( props.wphbData.isMember ) {
				...
				cdnDetails = getUnlockUpsellLink( props.wphbData.links.cdnUpsell, 'hb_cdn_upsell', trackCDNUpsell, __( 'Boost your speed globally. Serve your files from our optimized network for maximum performance.', 'wphb' ) );
			}
		...
		if ( props.wphbData.isMember ) {
			...
			delayDetails = getUnlockUpsellLink( props.wphbData.links.delayUpsell, 'delayjs', null, __( 'Unlock immediate speed. Visible content loads first, so your site feels faster.', 'wphb' ) );
		}
		...
		if ( props.wphbData.isMember ) {
			...
			criticalCssDetails = getUnlockUpsellLink( props.wphbData.links.criticalUpsell, 'critical_css', null, __( 'Instantly visible pages. Prioritize essential CSS above the fold for no lag.', 'wphb' ) );
		}
