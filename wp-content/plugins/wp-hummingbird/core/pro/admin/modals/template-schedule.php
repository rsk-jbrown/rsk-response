...
<div class="sui-border-frame">
	<div class="sui-form-field">
		...
		<select id="report-threshold<?php echo esc_attr( ( ! Utils::is_member() ) ? '-free' : '' ); ?>" class="sui-select" name="report-threshold">
			<?php if ( ! Utils::is_member() ) : ?>
				<option disabled value="0" ><?php esc_html_e( 'Instant', 'wphb' ); ?>
				</option>
			<?php else : ?>
