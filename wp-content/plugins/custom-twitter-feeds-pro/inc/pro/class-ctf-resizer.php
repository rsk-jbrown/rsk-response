...
class CTF_Resizer {
	...
	public function does_resizing_tables_exist() {
		...
		$table_name = esc_sql( $wpdb->prefix . CTF_FEEDS_POSTS_TABLE );
        $resizing_key = "ctf_resizing_exists";

        $ctf_resizing_cache = wp_cache_get( $resizing_key );

		if ( false === $ctf_resizing_cache ) {
